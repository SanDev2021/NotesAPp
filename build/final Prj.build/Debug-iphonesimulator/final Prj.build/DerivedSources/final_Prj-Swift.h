...
#ifndef FINAL_PRJ_SWIFT_H
#define FINAL_PRJ_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="final_Prj",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9final_Prj11AppDelegate")
...
SWIFT_CLASS("_TtC9final_Prj13SceneDelegate")
...
SWIFT_CLASS("_TtC9final_Prj24TaskdetailViewController")
@interface TaskdetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified taskView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9final_Prj14ViewController")
@interface ViewController : UIViewController <AVAudioPlayerDelegate, AVAudioRecorderDelegate>
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified playBtn;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified recordBtn;
- (void)viewDidLoad;
- (IBAction)RecordWithSender:(UIButton * _Nonnull)sender;
- (IBAction)PlayRecordedAudioWithSender:(UIButton * _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(final_Prj)) <MFMailComposeViewControllerDelegate>
...
SWIFT_CLASS("_TtC9final_Prj26foldersTableViewController")
@interface foldersTableViewController : UITableViewController
- (void)viewDidLoad;
@property (nonatomic, strong) IBOutlet UITableView * _Null_unspecified tableviewdata;
- (IBAction)newfolderbtn:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9final_Prj26moveTofloderViewController")
@interface moveTofloderViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (void)viewDidLoad;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9final_Prj24notesTableViewController")
@interface notesTableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified Enablebtn;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified trashvar;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified MoveVar;
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (IBAction)Enablebtn:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)Trashcells:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
